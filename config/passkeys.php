...
return [
    ...
    */
    ...
    /*
     * NİSOYA: paket varsayılanı ['password.confirm'] — ama bu uygulamada
     * password.confirm rotası hiç tanımlı değil (aynen bırakılsaydı passkey
     * ekleme uçları 500 verirdi). Uçlar zaten auth arkasında; passkey ekleme
     * 2FA/güvenlik sayfasından, taze oturumla yapılıyor — laragear'lı eski
     * akışla da birebir aynı davranış.
     */
    ...
    */
    ...
    // NİSOYA: parola girişiyle aynı hedef (url.intended önceliklidir —
    // paket redirect()->intended(bu değer) kullanır).
    'redirect' => '/panel',
