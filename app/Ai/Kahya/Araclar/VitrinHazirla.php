...
{
    public function __construct(private readonly ClaimableListingCreator $creator) {}
    ...
    public function description(): Stringable|string
    {
        return 'Keşfedilen veya harici bir Türk işletmesi için Nisoya üzerinde sahiplenilebilir ön vitrin oluşturur '
            .'ve 15 saniyelik sahiplenme davet bağlantısını (/sahiplen/{token}) üretir. '
    ...
    public function handle(Request $request): Stringable|string
    {
        try {
            ...
            return "BAŞARILI: Sahiplenilebilir vitrin oluşturuldu.\n"
                ."- İlan No: #{$listing->id}\n"
                ."- Başlık: {$listing->title}\n"
                ."- Konum: {$listing->city} ({$listing->country_code})\n"
                ."- Sahiplenme URL: {$claimUrl}\n"
                ."- Vitrin Önizleme URL: {$listingUrl}\n\n"
                .'Bu bağlantıyı işletme sahibine ulaştırabilir veya `hamle-oner` ile e-posta daveti planlayabilirsin.';
        } catch (Throwable $e) {
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'telefon' => $schema->string()
                ->description('İşletmenin telefon veya WhatsApp numarası.'),
