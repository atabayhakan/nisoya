...
class DiasporaMediaRadar extends Page
{
    ...
    protected string $view = 'filament.pages.diaspora-media-radar';
    ...
    {
        return [
            Action::make('addAccount')->label('Hesap ekle')->icon(Heroicon::OutlinedPlus)
    ...
    protected function getViewData(): array
    {
        ...
        return [
            ...
            'cards' => collect($reels->items())->map(function (DiasporaReel $reel): array {
                ...
                return [
                    ...
                    'username' => $account !== null ? $account->username : ($reel->instagram_username ?? 'Hesap atanmamış'),
                    'accountId' => $account?->id,
                    'verified' => $account !== null && $account->is_verified,
                    'activeAccount' => $account !== null && $account->is_active,
    ...
    /** @return Paginator<int, DiasporaReel> */
    protected function reels(): Paginator
    {
        return $this->scopedReels()->with(['country:code,name_tr', 'account:id,username,is_verified,is_active', 'latestAssessment'])
            ->orderByDesc('id')->simplePaginate(12, ['*'], 'radarPage', $this->radarPage);
    }

    /** @return Builder<DiasporaReel> */
    ...
    /** @return Builder<DiasporaAccount> */
