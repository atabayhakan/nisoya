...
<div class="grid gap-4 sm:grid-cols-2">
    <div>
        <label for="venue_name" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Mekan adı <span class="text-stone-400 dark:text-stone-500">(ops.)</span></label>
    ...
    <div>
        <label for="venue_address" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Adres <span class="text-stone-400 dark:text-stone-500">(ops.)</span></label>
...
<div>
    <label for="description" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Davet metni <span class="text-stone-400 dark:text-stone-500">(ops.)</span></label>
...
<div>
    <span class="block text-sm font-medium text-stone-700 dark:text-stone-300">Tema <span class="text-stone-400 dark:text-stone-500">(boş bırakırsan türe göre seçilir)</span></span>
        ...
        @foreach ($themes as $key => $theme)
            <label class="flex cursor-pointer items-center gap-3 rounded-xl border p-3 transition {{ $themeVal === $key ? 'border-emerald-500 ring-1 ring-emerald-300 dark:ring-emerald-700' : 'border-stone-200 hover:border-stone-300 dark:border-stone-700' }}">
                <input type="radio" name="theme" value="{{ $key }}" @checked($themeVal === $key)
                       class="border-stone-300 text-emerald-600 focus:ring-emerald-500 dark:border-stone-600">
