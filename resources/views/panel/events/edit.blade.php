            ...
            <div class="space-y-2 rounded-xl border border-stone-200 p-4 dark:border-stone-800">
                ...
                <label class="flex items-start gap-2 text-sm text-stone-700 dark:text-stone-300">
                    ...
                    <input type="checkbox" name="album_is_public" value="1" @checked(old('album_is_public', $event->album_is_public))
                           class="mt-0.5 rounded border-stone-300 text-emerald-700 focus:ring-emerald-500 dark:border-stone-600 dark:bg-stone-800">
                    <span>
                        ...
                        <span class="block text-xs text-stone-600 dark:text-stone-400">Açmadan önce fotoğraflardaki kişilerin rızası olduğundan emin ol — sorumluluk etkinlik sahibine aittir.</span>
                    </span>
                </label>
            </div>
