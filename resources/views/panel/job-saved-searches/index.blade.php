    ...
    <div class="mx-auto max-w-2xl px-4 py-10">
        ...
        @else
            <div class="mt-10 rounded-2xl border border-dashed border-stone-300 bg-white p-12 text-center dark:border-stone-700 dark:bg-stone-900">
                ...
                <p class="mt-1 text-sm text-stone-500 dark:text-stone-400">İş ilanlarında filtre uygula, sonra "Aramayı kaydet" ile buraya ekle.</p>
                <a href="{{ route('jobs.index') }}" class="mt-5 inline-block rounded-lg bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-emerald-700 hover:shadow-brand dark:bg-emerald-500 dark:hover:bg-emerald-400 dark:text-stone-900">İş ilanlarına git</a>
            </div>
        @endif
    </div>
</x-layouts.app>
