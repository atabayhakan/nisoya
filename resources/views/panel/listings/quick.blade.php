    ...
    <div class="mx-auto max-w-lg px-4 py-10" x-data="{ analyzing: false, preview: null, hasFile: false,
        ...
        <form method="POST" action="{{ route('panel.listings.analyze') }}" enctype="multipart/form-data"
            ...
            <label for="photo"
                ...
                <template x-if="!preview">
                    <span class="flex flex-col items-center gap-3">
                        <span class="grid h-16 w-16 place-items-center rounded-full bg-emerald-600 text-white dark:bg-emerald-500">
                        ...
                        <span class="text-xs text-stone-400 dark:text-stone-500">Kameran açılır — ürünü ortala ve çek</span>
                    </span>
                </template>
                <template x-if="preview">
            ...
            <button type="submit" x-show="hasFile" :disabled="analyzing" x-cloak
                    class="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-emerald-600 px-5 py-3 font-semibold text-white transition hover:bg-emerald-700 disabled:opacity-60 dark:bg-emerald-500 dark:hover:bg-emerald-400 dark:text-stone-900">
        ...
        <p class="mt-6 text-center text-xs text-stone-400 dark:text-stone-500">
