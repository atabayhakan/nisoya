...
<div class="grid gap-4 sm:grid-cols-3">
    <div>
        <label for="price" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Fiyat <span class="text-stone-600 dark:text-stone-400">(ops.)</span></label>
...
@if (($type ?? 'hizmet') === 'hizmet')
    <label class="flex items-center gap-2 text-sm text-stone-700 dark:text-stone-300">
        <input type="checkbox" name="is_remote" value="1" @checked(old('is_remote', $listing?->is_remote))
               class="rounded border-stone-300 text-emerald-700 focus:ring-emerald-500 dark:border-stone-600 dark:bg-stone-800">
        Bu hizmeti uzaktan / online verebiliyorum
    </label>
@elseif (($type ?? 'hizmet') === 'urun')
    <div>
        <label for="stock" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Stok adedi <span class="text-stone-600 dark:text-stone-400">(ops.)</span></label>
        ...
        <p class="mt-1 text-xs text-stone-600 dark:text-stone-400">Teslimat/kargo bilgilerini açıklamaya ekleyebilirsin.</p>
    </div>
    ...
    <div>
        <span class="block text-sm font-medium text-stone-700 dark:text-stone-300">Boyut <span class="text-stone-600 dark:text-stone-400">(ops., cm — girersen ilanda ölçek karşılaştırması gösterilir)</span></span>
...
@elseif (($type ?? 'hizmet') === 'emlak')
    ...
    <fieldset class="rounded-xl border border-stone-200 p-4 dark:border-stone-800">
        ...
        <div class="grid gap-4 sm:grid-cols-3">
            ...
            <div>
                <label for="area_m2" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Brüt m² <span class="text-stone-600 dark:text-stone-400">(ops.)</span></label>
            ...
            <div>
                <label for="floor" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Bulunduğu kat <span class="text-stone-600 dark:text-stone-400">(ops.)</span></label>
        ...
        <div class="mt-4 grid gap-4 sm:grid-cols-2">
            <div>
                <label for="deposit" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Depozito <span class="text-stone-600 dark:text-stone-400">(ops., ilan para biriminde)</span></label>
            ...
            <div>
                <label for="available_from" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Müsait tarih <span class="text-stone-600 dark:text-stone-400">(ops.)</span></label>
        ...
        <div class="mt-4 grid gap-4 sm:grid-cols-2">
            <div>
                <label for="max_guests" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Konuk kapasitesi <span class="text-stone-600 dark:text-stone-400">(kısa dönem, ops.)</span></label>
            ...
            <div>
                <label for="min_stay_nights" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Min. konaklama (gece) <span class="text-stone-600 dark:text-stone-400">(kısa dönem, ops.)</span></label>
        ...
        <div class="mt-4">
            <span class="block text-sm font-medium text-stone-700 dark:text-stone-300">Yeni gelenlere uygun <span class="text-stone-600 dark:text-stone-400">(işaretlediklerin ilanında rozet olur)</span></span>
...
@elseif (($type ?? 'hizmet') === 'vasita')
    ...
    <fieldset class="rounded-xl border border-stone-200 p-4 dark:border-stone-800">
        ...
        <div class="mt-4 grid gap-4 sm:grid-cols-2">
            <div>
                <label for="body_type" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Kasa tipi <span class="text-stone-600 dark:text-stone-400">(ops.)</span></label>
            ...
            <div>
                <label for="color" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Renk <span class="text-stone-600 dark:text-stone-400">(ops.)</span></label>
        ...
        <div class="mt-4 grid gap-4 sm:grid-cols-3">
            <div>
                <label for="min_rental_days" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Min. kiralama (gün) <span class="text-stone-600 dark:text-stone-400">(kiralık, ops.)</span></label>
            ...
            <div>
                <label for="deposit" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Depozito <span class="text-stone-600 dark:text-stone-400">(kiralık, ops.)</span></label>
            ...
            <div>
                <label for="km_limit_per_day" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Günlük km sınırı <span class="text-stone-600 dark:text-stone-400">(kiralık, ops.)</span></label>
        ...
        <div class="mt-4">
            <span class="block text-sm font-medium text-stone-700 dark:text-stone-300">Öne çıkan özellikler <span class="text-stone-600 dark:text-stone-400">(işaretlediklerin ilanında rozet olur)</span></span>
            <div class="mt-2 grid gap-2 sm:grid-cols-2">
