<x-layouts.app title="Yeni İlan Ver — Nisoya">
    <div class="mx-auto max-w-3xl px-4 py-10">
        ...
        <h1 class="mt-2 text-2xl font-bold text-stone-900 dark:text-stone-50">{{ $type === 'urun' ? 'Yeni Ürün İlanı' : 'Yeni Hizmet İlanı' }}</h1>
        ...
        <p class="mt-3 text-sm text-stone-500 dark:text-stone-400">{{ $type === 'urun' ? 'Evde ürettiğin ürünü sergile, alıcılarla buluş.' : 'Yeteneğini/hizmetini anlat, bulunduğun ülkedeki Türklerle buluş.' }}</p>
