<x-layouts.app title="Yeni İlan Ver — Nisoya">
    <div class="mx-auto max-w-3xl px-4 py-10">
        ...
        <h1 class="mt-2 text-2xl font-bold text-stone-900 dark:text-stone-50">{{ match ($type) { 'urun' => 'Yeni Ürün İlanı', 'emlak' => 'Yeni Emlak İlanı', default => 'Yeni Hizmet İlanı' } }}</h1>

        {{-- Tip seçimi --}}
        <div class="mt-4 inline-flex rounded-xl border border-stone-200 bg-white p-1 text-sm font-medium dark:border-stone-800 dark:bg-stone-900">
        ...
        <p class="mt-3 text-sm text-stone-500 dark:text-stone-400">{{ match ($type) { 'urun' => 'Evde ürettiğin ürünü sergile, alıcılarla buluş.', 'emlak' => 'Evini kirala, sat veya kısa dönem misafir ağırla — kendi insanınla güvenle.', default => 'Yeteneğini/hizmetini anlat, bulunduğun ülkedeki Türklerle buluş.' } }}</p>
