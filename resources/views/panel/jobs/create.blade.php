<x-layouts.app title="Yeni İş İlanı — Nisoya">
    <div class="mx-auto max-w-2xl px-4 py-8">
        ...
        <form method="POST" action="{{ route('panel.jobs.store') }}" class="mt-6 space-y-5 rounded-2xl border border-stone-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-900">
            ...
            <div class="pt-2">
                <button type="submit" class="rounded-lg bg-emerald-600 px-6 py-2.5 text-sm font-semibold text-white hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-400 dark:text-stone-900">İlanı yayınla</button>
            </div>
        </form>
    </div>
</x-layouts.app>
