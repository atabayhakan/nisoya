...
@if ($enabled && $slotId)
    ...
    >
        ...
        ></ins>
        <div class="border-t border-stone-200 bg-white px-3 py-1 text-center text-2xs uppercase tracking-wider text-stone-600 dark:border-stone-800 dark:bg-stone-900 dark:text-stone-400">
            Reklam
        </div>
    </div>
    <script>
