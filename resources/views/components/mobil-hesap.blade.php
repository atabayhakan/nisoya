{{-- MOBİLDE HESAP GÖRÜNÜRLÜĞÜ (2026-08-05).
     ...
     dair hiçbir şey görünmüyor." Doğruydu: giriş yapmışken avatar/ad/çıkış —
     hepsi `hidden md:*` idi. Telefonda oturumun açık olduğunu gösteren TEK
     işaret alt çubuktaki "Panelim" yazısıydı; çıkış ise yalnız "Keşfet" alt
     sayfasının dibinde vardı.
     ...
     MİSAFİR DALI YOK (2026-08-21'de kaldırıldı): burada "Giriş"/"Kayıt"
     taşıyan bir yelpaze düğmesi vardı, alt sekme çubuğundaki "İlan Ver"
     FAB'ına taşındı — bkz. x-mobile-tab-bar. Sebep: o FAB'ın etrafında zaten
     boşluk var (dairesel açılım için), başlığın köşesinde hiç yoktu. --}}
@auth
