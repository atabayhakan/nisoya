<x-layouts.app>
    <div class="mx-auto max-w-2xl px-4 py-8">
        <div class="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm sm:p-8 dark:border-stone-800 dark:bg-stone-900">
            ...
            <form method="POST" action="{{ route('football.teams.store') }}" enctype="multipart/form-data" id="teamForm" class="mt-6 space-y-6">
                @csrf
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-6">
                        ...
                        <div class="flex-1 text-center sm:text-left">
                            ...
                            <h3 class="mt-1 text-base font-extrabold tracking-tight text-white">
                                Profesyonel Kulüp Arması Üret
                            </h3>
                            <p class="mt-1 text-xs text-stone-300 leading-relaxed">
                                Takım adı, şehir ve forma renklerinize göre metalik kalkan, kulüp monogramı ve maskot içeren resmi EA FC vektör arması oluşturun.
                            </p>
                            ...
                            <div class="mt-3 flex flex-wrap items-center gap-2">
                                <button type="button" id="btnGenerateAiCrest" class="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 px-4 py-2 text-xs font-black text-stone-950 shadow-md transition hover:from-amber-400 hover:to-amber-500 active:scale-95">
                                    ...
                                    <span id="aiBtnText">✨ Armayı Yapay Zekayla Üret</span>
                                </button>
                ...
                <div>
                    ...
                    <input type="text" name="name" id="teamNameInput" value="{{ old('name') }}" required placeholder="Örn: Berlin Hilalspor, Kreuzberg United, Boğaziçi FC"
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="city" id="teamCityInput" value="{{ old('city', $defaultCity) }}" required placeholder="Örn: Berlin, Köln, Frankfurt, İstanbul"
                               class="mt-1.5 w-full rounded-xl border border-stone-200 bg-stone-50 px-3.5 py-2.5 text-sm focus:border-emerald-500 focus:bg-white focus:outline-none dark:border-stone-700 dark:bg-stone-800 dark:text-stone-100">
                    </div>
                    <div>
                ...
                <div class="rounded-2xl border border-stone-200 bg-stone-50 p-4 dark:border-stone-800 dark:bg-stone-900/50">
                    ...
                    <div class="mt-3 grid gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="primary_kit_color" id="primaryKitInput" value="{{ old('primary_kit_color', 'Kırmızı') }}" placeholder="Örn: Kırmızı, Bordo, #dc2626"
                        ...
                        <div>
                            ...
                            <input type="text" name="secondary_kit_color" id="secondaryKitInput" value="{{ old('secondary_kit_color', 'Beyaz') }}" placeholder="Örn: Beyaz, Siyah, #0f172a"
                                   class="mt-1 w-full rounded-xl border border-stone-200 bg-white px-3.5 py-2 text-sm focus:border-emerald-500 dark:border-stone-700 dark:bg-stone-800 dark:text-stone-100">
                        </div>
                    </div>
                ...
                {{-- Özel Logo Yükleme (Opsiyonel alternatif) --}}
                <div>
                    <label class="block text-xs font-bold uppercase text-stone-700 dark:text-stone-300">Veya Kendi Logonuzu Yükleyin</label>
                    <input type="file" name="logo" id="customLogoFileInput" accept="image/*"
                    ...
                    <p class="mt-1 text-[11px] text-stone-500 dark:text-stone-400">Yapay zeka armasını kullanmak istiyorsanız dosya seçmenize gerek yoktur.</p>
                </div>
