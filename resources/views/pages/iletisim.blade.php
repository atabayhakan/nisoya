            ...
            <div class="lg:col-span-3">
                <div class="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm sm:p-8">
                    ...
                    <form method="POST" action="{{ route('contact.store') }}" class="space-y-4">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                <label for="phone" class="block text-sm font-medium text-stone-700">Telefon <span class="text-stone-400">(ops.)</span></label>
                        ...
                        <button type="submit" class="w-full rounded-lg bg-emerald-600 px-5 py-2.5 font-semibold text-white transition hover:bg-emerald-700 sm:w-auto">
                            Mesajı Gönder
                        </button>
                    </form>
                </div>
