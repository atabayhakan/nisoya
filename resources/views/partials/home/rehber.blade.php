{{-- Ülke rehberi (F2) — konsolosluk işlem rehberinin ana sayfa yüzü.

     Veri sözleşmesi HomeController::rehberVerisi: modül kapalıysa ya da hiçbir
     ülkenin YAYINDA içeriği yoksa $rehber null gelir ve bölüm hiç basılmaz.
     Ülke önceliği K1 (üye ikameti > GeoIP); çözülen ülke hazır değilse bölüm
     hazır ülkeleri önerir — varsayılan dayatmaz. Ülke pilleri aynı zamanda
     K1'in "elle ülke değiştirici" şartıdır. --}}
