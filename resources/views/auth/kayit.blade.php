<x-layouts.guest title="Kayıt Ol — Nisoya">
    ...
    <form method="POST" action="{{ route('register') }}" class="mt-6 space-y-4">
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            <div>
                <label for="city" class="block text-sm font-medium text-stone-700">Şehir <span class="text-stone-600">(ops.)</span></label>
        ...
        <label class="flex items-start gap-2 text-sm text-stone-600">
            <input type="checkbox" name="terms" value="1" @checked(old('terms')) class="mt-0.5 rounded border-stone-300 text-emerald-700 focus:ring-emerald-500">
