<x-layouts.guest title="Şifre Sıfırla — Nisoya">
    <h1 class="text-xl font-bold text-stone-900 dark:text-stone-50">Yeni şifre belirle</h1>
    <p class="mt-1 text-sm text-stone-500 dark:text-stone-400">Hesabın için yeni bir şifre oluştur.</p>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="mt-6 space-y-4">
        ...
        <div>
            <label for="password" class="block text-sm font-medium text-stone-700 dark:text-stone-300">Yeni şifre</label>
