<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <p class="my-4 text-sm text-gray-600 dark:text-gray-300">Puan arz göstergesidir; işlem hacmi veya AI tahmini değildir. Ülkesi bilinmeyen kayıtlar ve kapalı pazarlar bu toplamlara dahil değildir. Şehir görünümü mevcut şehir adı eşleşmesini kullanır.</p>
